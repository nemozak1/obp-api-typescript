...
import { CreateAccountRequestJsonV500 } from '../models';
import { CreateAccountResponseJsonV310 } from '../models';
...
export const OnboardingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {CreateAccountRequestJsonV500} body CreateAccountRequestJsonV500 object that needs to be added.
         * @param {string} ACCOUNT_ID The account id
         * @param {string} BANK_ID The bank id
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        oBPv500CreateAccount: async (body: CreateAccountRequestJsonV500, ACCOUNT_ID: string, BANK_ID: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
...
export const OnboardingApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async oBPv500CreateAccount(body: CreateAccountRequestJsonV500, ACCOUNT_ID: string, BANK_ID: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<CreateAccountResponseJsonV310>>> {
...
export const OnboardingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async oBPv500CreateAccount(body: CreateAccountRequestJsonV500, ACCOUNT_ID: string, BANK_ID: string, options?: AxiosRequestConfig): Promise<AxiosResponse<CreateAccountResponseJsonV310>> {
...
export class OnboardingApi extends BaseAPI {
     ...
     * @memberof OnboardingApi
     */
    public async oBPv500CreateAccount(body: CreateAccountRequestJsonV500, ACCOUNT_ID: string, BANK_ID: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<CreateAccountResponseJsonV310>> {
