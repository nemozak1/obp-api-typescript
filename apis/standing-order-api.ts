...
import { PostStandingOrderJsonV400 } from '../models';
import { StandingOrderJsonV400 } from '../models';
/**
...
export const StandingOrderApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {PostStandingOrderJsonV400} body PostStandingOrderJsonV400 object that needs to be added.
         ...
         */
        oBPv400CreateStandingOrder: async (body: PostStandingOrderJsonV400, VIEW_ID: string, ACCOUNT_ID: string, BANK_ID: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        oBPv400CreateStandingOrderManagement: async (body: PostStandingOrderJsonV400, ACCOUNT_ID: string, BANK_ID: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
...
export const StandingOrderApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async oBPv400CreateStandingOrder(body: PostStandingOrderJsonV400, VIEW_ID: string, ACCOUNT_ID: string, BANK_ID: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<StandingOrderJsonV400>>> {
         ...
         * @throws {RequiredError}
         */
        async oBPv400CreateStandingOrderManagement(body: PostStandingOrderJsonV400, ACCOUNT_ID: string, BANK_ID: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<StandingOrderJsonV400>>> {
...
export const StandingOrderApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async oBPv400CreateStandingOrder(body: PostStandingOrderJsonV400, VIEW_ID: string, ACCOUNT_ID: string, BANK_ID: string, options?: AxiosRequestConfig): Promise<AxiosResponse<StandingOrderJsonV400>> {
         ...
         * @throws {RequiredError}
         */
        async oBPv400CreateStandingOrderManagement(body: PostStandingOrderJsonV400, ACCOUNT_ID: string, BANK_ID: string, options?: AxiosRequestConfig): Promise<AxiosResponse<StandingOrderJsonV400>> {
...
export class StandingOrderApi extends BaseAPI {
     ...
     */
    public async oBPv400CreateStandingOrder(body: PostStandingOrderJsonV400, VIEW_ID: string, ACCOUNT_ID: string, BANK_ID: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<StandingOrderJsonV400>> {
     ...
     * @memberof StandingOrderApi
     */
    public async oBPv400CreateStandingOrderManagement(body: PostStandingOrderJsonV400, ACCOUNT_ID: string, BANK_ID: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<StandingOrderJsonV400>> {
