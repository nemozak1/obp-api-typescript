 ...
 *
 * @export
 * @interface DynamicmessagedocsDYNAMICMESSAGEDOCIDBody1
 */
export interface DynamicmessagedocsDYNAMICMESSAGEDOCIDBody1 {

    /**
     * @type {string}
     * @memberof DynamicmessagedocsDYNAMICMESSAGEDOCIDBody1
     */
