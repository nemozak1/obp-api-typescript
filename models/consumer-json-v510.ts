...
import { CertificateInfoJsonV510 } from './certificate-info-json-v510';
import { ResourceUserJSON } from './resource-user-json';
 /**
 * 
 *
 * @export
 * @interface ConsumerJsonV510
 */
export interface ConsumerJsonV510 {

    /**
     * @type {string}
     * @memberof ConsumerJsonV510
     * @example Web
     */
    app_type: string;
...
-----END CERTIFICATE-----
    ...
    /**
     * @type {CertificateInfoJsonV510}
     * @memberof ConsumerJsonV510
     */
    certificate_info?: CertificateInfoJsonV510;
