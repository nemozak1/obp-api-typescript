 ...
 *
 * @export
 * @interface InlineResponse2009MetadataCorporateLocation
 */
export interface InlineResponse2009MetadataCorporateLocation {

    /**
     * @type {number}
     * @memberof InlineResponse2009MetadataCorporateLocation
     * @example 1.231
     */
    latitude: number;
