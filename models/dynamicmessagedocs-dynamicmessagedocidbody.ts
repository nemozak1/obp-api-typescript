 ...
 *
 * @export
 * @interface DynamicmessagedocsDYNAMICMESSAGEDOCIDBody
 */
export interface DynamicmessagedocsDYNAMICMESSAGEDOCIDBody {

    /**
     * @type {string}
     * @memberof DynamicmessagedocsDYNAMICMESSAGEDOCIDBody
     */
