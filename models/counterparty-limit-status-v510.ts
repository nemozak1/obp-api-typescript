...
import { CounterpartyLimitStatus } from './counterparty-limit-status';
 /**
 * 
 *
 * @export
 * @interface CounterpartyLimitStatusV510
 */
export interface CounterpartyLimitStatusV510 {

    /**
     * @type {string}
     * @memberof CounterpartyLimitStatusV510
