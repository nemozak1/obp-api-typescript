 ...
 *
 * @export
 * @interface SANDBOXTANTransactionrequestsBody
 */
export interface SANDBOXTANTransactionrequestsBody {

    /**
     * @type {Obpv210banksBANKIDaccountsACCOUNTIDVIEWIDtransactionrequesttypesSANDBOXTANtransactionrequestsTo}
     * @memberof SANDBOXTANTransactionrequestsBody
     */
    to: Obpv210banksBANKIDaccountsACCOUNTIDVIEWIDtransactionrequesttypesSANDBOXTANtransactionrequestsTo;
