 ...
 *
 * @export
 * @interface EndpointmappingsENDPOINTMAPPINGIDBody1
 */
export interface EndpointmappingsENDPOINTMAPPINGIDBody1 {

    /**
     * @type {string}
     * @memberof EndpointmappingsENDPOINTMAPPINGIDBody1
