 ...
 *
 * @export
 * @interface DynamicresourcedocsDYNAMICRESOURCEDOCIDBody1
 */
export interface DynamicresourcedocsDYNAMICRESOURCEDOCIDBody1 {

    /**
     * @type {string}
     * @memberof DynamicresourcedocsDYNAMICRESOURCEDOCIDBody1
